                  ...
                  <div className="relative">
                    ...
                    <div className="bg-neutral-50 dark:bg-white/[0.025] p-8 md:p-12 transition-colors relative z-0 rounded-none">
                       ...
                       <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                          ...
                          <div>
                             ...
                             <ul className="space-y-3">
                                {item.includes?.map((inc: string, j: number) => (
                                  <li key={j} className="text-[15px] text-neutral-700 dark:text-neutral-300 flex items-start gap-4 leading-relaxed">
                          ...
                          <div>
                             ...
                             <button
                               ...
                               className="flex items-center justify-between w-full py-3 px-0 bg-transparent hover:text-neutral-900 dark:hover:text-white transition-colors text-left group/btn rounded-none outline-none border-b border-neutral-200 dark:border-white/10 hover:border-neutral-400 dark:hover:border-[#D4FF00]/40 focus-visible:border-neutral-400 dark:focus-visible:border-[#D4FF00]"
                             >
                               <span className="text-[14px] text-neutral-700 dark:text-neutral-300 group-hover/btn:text-neutral-900 dark:group-hover/btn:text-white transition-colors">
                               ...
                               >
                                  <ChevronDown size={16} className="text-neutral-500 dark:text-[#D4FF00]" strokeWidth={1.5} />
                               </motion.div>
                             </button>
                                  ...
                                  >
                                     <ul className="flex flex-col pt-4">
                                        {item.whats_inside?.map((inc: string, j: number) => (
                                           <li key={j} className="text-[13px] text-neutral-600 dark:text-neutral-400 flex items-start gap-4 py-3 border-b border-neutral-100 dark:border-white/5 last:border-b-0">
                                              <span className="w-1 h-1 bg-neutral-400 dark:bg-neutral-600 mt-[9px] shrink-0 rounded-none" />
                                              {inc}
                                           </li>
                                        ))}
                                     </ul>
                       ...
                       <div className="relative pl-6 md:pl-8 border-l-2 border-[#D4FF00]">
                           ...
                           <p className="text-lg md:text-xl text-neutral-900 dark:text-white font-medium leading-snug max-w-3xl tracking-tight">
                              {item.output}
                           </p>
                       </div>
