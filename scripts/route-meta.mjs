...
export const ROUTE_META = {
  "/": {
    ...
    description:
      "Strategic design partner for multi-location organizations. From strategy to rollout-ready delivery, powered by the r3loop methodology - predictable quality and speed at scale.",
    ogImage: OG("home"),
  },
  "/work": {
