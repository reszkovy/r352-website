        ...
        <div className="grid grid-cols-1 md:grid-cols-[420px_1fr] gap-10 md:gap-16 items-start max-w-5xl">
          ...
          <Reveal delay={0.1}>
            <div className="space-y-5 max-w-xl text-[15px] md:text-base text-neutral-700 dark:text-neutral-300 leading-relaxed">
              ...
              <p>
                {language === 'pl'
                  ? <>Zaczynałem w Deloitte Digital. Potem Lizbona, Barcelona, pięć innych miast &mdash; Kubota, trasy Dawida Podsiadły z Muzk, w międzyczasie Pelion. Globalne turnieje FIFA, platforma ubezpieczeniowa UNIQA, produkty blockchain w erze web3. Różne branże, różne agencje, różna skala &mdash; ale zawsze ten sam wzorzec. Seniorzy uwięzieni w pętlach poprawek. Briefy, które potrzebowały trzech rund zanim cokolwiek poszło. Spójność marki przeciekająca między lokalizacjami, których nikt nie miał czasu audytować. Spotkania strategiczne przerywane &bdquo;jeszcze tylko jeden baner&rdquo;.</>
                  : <>I started at Deloitte Digital. Then Lisbon, then Barcelona, then five other cities &mdash; Kubota, Dawid Podsiadło&apos;s tours with Muzk, Pelion in between. FIFA tournament systems, UNIQA&apos;s insurance platform, blockchain products during the web3 wave. Different industries, different agencies, different scales &mdash; but always the same pattern. Senior designers stuck in revision loops. Briefs that needed three rounds before anyone could ship. Brand consistency leaking across locations nobody had time to audit. Strategy meetings interrupted by &ldquo;just one more banner.&rdquo;</>}
              </p>
              <p>
                {language === 'pl'
