export const translations = {
  en: {
    ...
    hero: {
      ...
      description_body: "Retainer for the steady. Project for the sharp. Same r3loop — applied to both, and to my own products in production.",
  ...
  pl: {
    ...
    hero: {
      ...
      description_body: "Retainer dla stabilnych. Projekt dla ostrych. To samo r3loop — zastosowane do obu, i do moich własnych produktów w produkcji.",
